...
TRF_DIR = DATA_ROOT / 'my_TRFs_alpha3'
...
models = { #38號
    ...
    'gammatone-lin+log': [gammatone_lin, gammatone],#這
    # The acoustic edge detection model
    'envelope+onset': [envelope, onset_envelope],#這
    'acoustic': [gammatone, gammatone_onsets],
    # Models with word-onsets and word-class
    'words': [word_onsets],
    'words+lexical': [word_onsets, word_lexical, word_nlexical],#這
...
for subject in SUBJECTS:
    ...
    raw = mne.io.read_raw("C:\\Users\\User\\Data\\Alice\\eeg\\S38\\remove_alpha-raw_3.fif", preload=True)
